...
REM
REM  DESCRIPTION
REM    This file is used to call the Forms XMLValidator tool. The tool
REM    takes .xml files and validates them against the Forms XMLSchema.
REM 
REM  NOTES
REM    It wraps the class oracle.forms.util.xmltools.XMLValidator and passes
...
%FORMS_JDK_HOME%\java -classpath C:\Oracle\MIDDLE~1\ORACLE~2\jlib\frmxmltools.jar;C:\Oracle\MIDDLE~1\ORACLE~2\jlib\frmjdapi.jar;C:\Oracle\MIDDLE~1\ORACLE~2\oracle_common\modules\oracle.xdk\xmlparserv2.jar oracle.forms.util.xmltools.XMLValidator %*
