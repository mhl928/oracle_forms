...
REM
REM  DESCRIPTION
REM    This file is used to call the XML2Forms conversion tool.
REM    It takes .xml files, validates each against the Forms
REM    XMLSchema, and if it validates successfully, converts the .xml
REM    file into the appropriate .fmb, .mmb, or .olb file. 
REM 
REM  NOTES
REM    It wraps the class oracle.forms.util.xmltools.XML2Forms and passes
...
%FORMS_JDK_HOME%\java -classpath C:\Oracle\MIDDLE~1\ORACLE~2\jlib\frmxmltools.jar;C:\Oracle\MIDDLE~1\ORACLE~2\jlib\frmjdapi.jar;C:\Oracle\MIDDLE~1\ORACLE~2\oracle_common\modules\oracle.xdk\xmlparserv2.jar oracle.forms.util.xmltools.XML2Forms %*
